    ...
    var presentationStyle: PromptPresentationStyle {
        if isPrivacyMode {
            return PromptPresentationStyle(
                ...
                primaryTextColor: Color(red: 55/255, green: 55/255, blue: 55/255),
                secondaryTextColor: Color(red: 60/255, green: 60/255, blue: 60/255),
                codeTextColor: Color(red: 55/255, green: 55/255, blue: 55/255),
                accentColor: Color(red: 65/255, green: 65/255, blue: 65/255),
                textOpacityMultiplier: 0.35,
                panelOpacityMultiplier: 0.35,
                hintOpacity: 0.3,
                dividerOpacity: 0.05,
                subtleFillOpacity: 0.03,
                panelBorderOpacity: 0.06,
                shadowOpacity: 0.15,
                shadowRadius: 1,
                shadowYOffset: 0.5,
...
"""#),
    ...
    使用技巧：
    - 🔒 隐私模式：将应用从 Dock 隐藏。开启后请在应用处于活动状态时操作。
    - 👻 幽灵模式：开启后鼠标穿透，应用进入绝对安全锁定。需等待倒计时结束自动恢复。
    - 🎥 录屏防护：开启后 Zoom/OBS 等软件捕获到的窗口将完全透明（取决于系统版本）。
